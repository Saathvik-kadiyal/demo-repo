...
const AccountManagerTable = ({ data = [], clickedClient, selectedColor }) => {
  ...
  const columns = [
    ...
    { field: "headCount", headerName: "Head Count", width: 128 },
    { field: "shiftA", headerName: "Shift A", width: 128 },
    { field: "shiftB", headerName: "Shift B", width: 128 },
    { field: "shiftC", headerName: "Shift C", width: 128 },
    { field: "shiftPRIME", headerName: "PRIME", width: 128 },
    {
